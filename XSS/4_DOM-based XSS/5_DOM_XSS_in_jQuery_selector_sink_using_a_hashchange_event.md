...
Si buscamos una etiqueta `h2` dentro de la sección `blog-list`, por ejemplo `Perserverance` y lo añadimos como hashtag, vemos que el script actúa y se realiza un scroll down hacia ese elemento:
